...
<head>
    ...
    <title>Portal de Suporte - <?= $configs['empresa_nome'] ?? 'HelpDesk TI' ?></title>
...
<body>
    <div class="portal-header">
        ...
        <h1><?= $configs['empresa_nome'] ?? 'HelpDesk TI' ?></h1>
    ...
    <div class="portal-container">
        ...
        <div class="portal-footer">
            <p>Powered by <a href="<?= BASE_URL ?>">HelpDesk TI</a> | <a href="<?= BASE_URL ?>/login.php">Área Administrativa</a></p>
        </div>
    </div>
